...
<head>
    ...
    <style>
        ...
        .login-card    { border: none; border-radius: 1rem; box-shadow: 0 20px 60px rgba(0,0,0,.35); max-width: 420px; width: 100%; }
        .login-header  { background: linear-gradient(135deg, #1e3a5f, #2d6a9f); border-radius: 1rem 1rem 0 0; padding: 2rem; text-align: center; color: #fff; }
        .login-header i { font-size: 3rem; }
        .login-body    { padding: 2rem; }
        .btn-login     { background: linear-gradient(135deg, #1e3a5f, #2d6a9f); color: #fff; border: none; }
